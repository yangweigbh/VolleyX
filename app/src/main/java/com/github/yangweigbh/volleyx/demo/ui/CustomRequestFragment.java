...
import com.github.yangweigbh.volleyx.demo.request.GsonRequest;
...
public class CustomRequestFragment extends Fragment {
    ...
    private static final String TAG = "CustomRequestFragment";
    private static final String URL = "https://api.douban.com/v2/music/search?tag=rock&count=20";

    RecyclerView mRecyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private JsonMapper mapper;
    private CustomRequestFragment.ItemRecyclerViewAdapter mAdapter;
     ...
     *
     * @return A new instance of fragment CustomRequestFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CustomRequestFragment newInstance() {
        CustomRequestFragment fragment = new CustomRequestFragment();
        return fragment;
    }
    ...
    void refreshItems() {
        final GsonRequest<Result> request = new GsonRequest<>(URL, Result.class, null, null);
        VolleyX.from(request, "mListener1").subscribeOn(Schedulers.io())
                .map(new Func1<Result, List<Music>>() {
                    @Override
                    public List<Music> call(Result result) {
    ...
    public static class ItemRecyclerViewAdapter extends RecyclerView.Adapter<CustomRequestFragment.ItemRecyclerViewAdapter.ViewHolder> {
        ...
        @Override
        public CustomRequestFragment.ItemRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new CustomRequestFragment.ItemRecyclerViewAdapter.ViewHolder(mLayoutInflater.inflate(R.layout.item, parent, false));
        }

        @Override
        public void onBindViewHolder(CustomRequestFragment.ItemRecyclerViewAdapter.ViewHolder holder, int position, List<Object> payloads) {
            if(payloads.isEmpty()) {
        ...
        @Override
        public void onBindViewHolder(CustomRequestFragment.ItemRecyclerViewAdapter.ViewHolder holder, int position) {
